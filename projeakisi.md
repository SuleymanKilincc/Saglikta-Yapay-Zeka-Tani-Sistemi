...
Süleyman Kılınç (Scrum Master / Yönetici): 2. hafta planlaması ve genel koordinasyon süreci yönetildi.

Ömer Ensar Şahin: Kullanım Durumu (Use Case) Diyagramı hazırlandı.

Cumali Bilgiç: Sistem Akış Şeması (Flowchart) hazırlandı.
